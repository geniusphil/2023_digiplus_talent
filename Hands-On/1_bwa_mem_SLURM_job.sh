...
#SBATCH -o /home/p6elin0111/results/bwamem_out.log          # Path to the standard output file 
#SBATCH -e /home/p6elin0111/results/bwamem_err.log          # Path to the standard error ouput file
