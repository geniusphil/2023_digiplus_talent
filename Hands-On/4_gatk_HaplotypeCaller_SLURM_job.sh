...
#SBATCH -J gatk_haplotype_caller_job       # Job name
#SBATCH -p ngscourse           # Partition Name 等同PBS裡面的 -q Queue name
#SBATCH -c 2               # 使用的數 請參考Queue資源設定 
#SBATCH --mem=13g           # 使用的記憶體量 請參考Queue資源設定
#SBATCH -o /home/p6elin0111/results/gatk_haplotype_caller.log          # Path to the standard output file 
#SBATCH -e /home/p6elin0111/results/gatk_haplotype_caller_err.log          # Path to the standard error ouput file
...
REF_HG38_FASTA_1="/opt/ohpc/Taiwania3/pkg/biology/reference/Homo_sapiens/GATK/hg38/Homo_sapiens_assembly38.fasta"
DBSNP_HG19=""
DBSNP_HG38="/opt/ohpc/Taiwania3/pkg/biology/reference/Homo_sapiens/GATK/hg38/dbsnp_146.hg38.vcf.gz"
RGID="NA20318"
RGSM="NA20318"
RGLB="Illumina"
RGPL="Illumina"
